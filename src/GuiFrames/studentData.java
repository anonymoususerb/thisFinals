...
public class studentData extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        stuTable = new UserInterface.CustomComponents.MyTable();
        ...
        stuTable.setFont(new java.awt.Font("Segoe Print", 0, 12)); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this, "Invalid Student ID.", "Input Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String firstName = txtFirstName2.getText().trim().isEmpty() ? selectedStudent.getFirstName() : txtFirstName2.getText().trim();
        String lastName = txtLastName2.getText().trim().isEmpty() ? selectedStudent.getLastName() : txtLastName2.getText().trim();
        String middleInitial = txtMiddleName2.getText().trim().isEmpty() ? selectedStudent.getMiddleInitial() : txtMiddleName2.getText().trim();
        ...
        saveStudentData(); // Save data after updating
        clearTable();
    ...
    private UserInterface.CustomComponents.MyTable stuTable;
